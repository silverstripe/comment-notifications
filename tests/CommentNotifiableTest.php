...
class CommentNotifiableTest extends SapphireTest
{
    ...
    public function testGetRecipients()
    {
        ...
        $this->assertEquals(['myadmin@mysite.com', 'andrew@address.com'], $item1->notificationRecipients($comment1));
        $this->assertEquals(['myadmin@mysite.com'], $item2->notificationRecipients($comment2));
    }
